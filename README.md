...
![image](https://user-images.githubusercontent.com/5498512/194798920-8e283f53-976c-4934-9865-7b7b4ffc78b4.png)
...
mpiexec -n $NUM_GPUS python classifier_sample.py $SAG_FLAGS $MODEL_FLAGS --classifier_scale 0.0 --classifier_path models/256x256_classifier.pt --model_path models/256x256_diffusion.pt $SAMPLE_FLAGS
```
